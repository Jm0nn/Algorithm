package com.jm0nn.programmers.lv4;

public class LV4_사칙연산 {
    public static void main(String[] args) {
        LV4_사칙연산 lv4 = new LV4_사칙연산();
        System.out.println(lv4.solution(new String[]{"1", "-", "3", "+", "5", "-", "8"})); // 1
        System.out.println(lv4.solution(new String[]{"5", "-", "3", "+", "1", "+", "2", "-", "4"})); // 3
    }
